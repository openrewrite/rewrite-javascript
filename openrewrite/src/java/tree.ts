...
import {Comment, Expression, J, JMixin, JavaSourceFile, JavaType, JContainer, JLeftPadded, JRightPadded, Loop, MethodCall, NameTree, Space, Statement, TextComment, TypedTree, TypeTree} from "./support_types";
...
export namespace ClassDeclaration {
    ...
    export class Kind extends JMixin(Object) {
        public constructor(id: UUID, prefix: Space, markers: Markers, annotations: Annotation[], _type: Kind.Type) {
            super();
            this._id = id;
            this._prefix = prefix;
            this._markers = markers;
...
export class Parentheses<J2 extends Tree> extends JMixin(Object) implements Expression {
...
export class ControlParentheses<J2 extends Tree> extends JMixin(Object) implements Expression {
    public constructor(id: UUID, prefix: Space, markers: Markers, tree: JRightPadded<J2>) {
        super();
        this._id = id;
        this._prefix = prefix;
